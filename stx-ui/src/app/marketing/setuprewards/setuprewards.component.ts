...
export class SetupRewardsComponent implements OnInit {
      ...
      data => {
        ...
        for (let i = 0; i < this.rewardDataList.length ; i++) {
          for (let j = 0; j < this.rewardDataList[i].Award_Rules__c.length ; j++) {
                this.rewardDataList[i].Award_Rules__c[j].startDate = new Date(this.rewardDataList[i].Award_Rules__c[j].startDate);
                this.rewardDataList[i].Award_Rules__c[j].endDate = new Date(this.rewardDataList[i].Award_Rules__c[j].endDate);
          }
          for (let j = 0; j < this.rewardDataList[i].Redeem_Rules__c.length ; j++) {
            this.rewardDataList[i].Redeem_Rules__c[j].startDate = new Date(this.rewardDataList[i].Redeem_Rules__c[j].startDate);
            this.rewardDataList[i].Redeem_Rules__c[j].endDate = new Date(this.rewardDataList[i].Redeem_Rules__c[j].endDate);
            }
         }
       },
       error => {
  ...
  rewardformsave() {
    ...
    // for (let i = 0; i < this.awardArrayData.length; i++) {
    //   if ( this.awardArrayData[i].startDate !== '' && this.awardArrayData[i].startDate !== null) {
    //     this.awardArrayData[i].startDate = this.commonService.getDBDatStr(this.awardArrayData[i].startDate);
    //   }
    //   if ( this.awardArrayData[i].endDate !== '' && this.awardArrayData[i].endDate !== null) {
    //     this.awardArrayData[i].endDate = this.commonService.getDBDatStr(this.awardArrayData[i].endDate);
    //   }
    // }
    // for (let i = 0; i < this.redeemArrayData.length; i++) {
    //   if (this.redeemArrayData[i].startDate !== '' && this.redeemArrayData[i].startDate !== null) {
    //     this.redeemArrayData[i].startDate = this.commonService.getDBDatStr(this.redeemArrayData[i].startDate);
    //   }
    //   if (this.redeemArrayData[i].endDate !== '' && this.redeemArrayData[i].endDate !== null) {
    //     this.redeemArrayData[i].endDate = this.commonService.getDBDatStr(this.redeemArrayData[i].endDate);
    //   }
    // }
    ...
    if (this.rewardForm.value.name === '' || this.rewardForm.value.name === null || this.rewardForm.value.name === undefined) {
      ...
      if ( this.addDiv === true) {
        ...
        const rewardname = this.rewardForm.value.name;
